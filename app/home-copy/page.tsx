      ...
      <div className="flex flex-col items-center justify-center min-h-screen pb-40 px-4">
          ...
          !(mode === 'create-video' && isLoadingUI) && (
            <div className="w-full max-w-5xl mx-auto">
              {mode === 'compose-image' ? (
                ...
                <div className="flex flex-col gap-6 items-center">
                  ...
                  <div className="flex flex-col gap-4 w-full max-w-md">
                    ...
                    <div className="text-xs text-center -mt-2 mb-2">
                      {(imageFile || generatedImage) && (
                        <div className="text-blue-600">✓ Base image ready</div>
                      )}
                      {multipleImageFiles.length > 0 && (
                        <div className="text-green-600">
                          ✓ {multipleImageFiles.length} additional image
                    ...
                    {multipleImageFiles.length > 0 && (
                      <div className="flex flex-wrap gap-2 justify-center">
                        {multipleImageFiles.map((file, index) => (
                          <div
                            key={index}
                            className="w-16 h-16 rounded-lg overflow-hidden border border-white/30 shadow-sm"
                            title={file.name}
                          >
                            <Image
                              src={URL.createObjectURL(file)}
                ...
                /* Other modes: Standard image display */
                <div className="w-full max-w-2xl aspect-video overflow-hidden rounded-lg border relative mx-auto">
                  <Image
                    src={generatedImage}
                    alt="Generated"
                    className="w-full h-full object-contain"
        ...
        {videoUrl && (
          <div className="w-full max-w-4xl mx-auto">
            <VideoPlayer
              src={videoUrl}
              onTrimmedOutput={handleTrimmedOutput}
              onResetTrimState={handleResetTrimState}
            />
          </div>
        )}
      </div>
